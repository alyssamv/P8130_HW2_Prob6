...
ggplot(migraine_data, aes(x = migraine, y = cesd)) +
  ...
  ggtitle(label = 'Distribution of CESD scores among patients with and without migraine') +
...
ggplot(migraine_data, aes(x = migraine, y = nddie)) +
  geom_boxplot(aes(fill = migraine)) +
  ggtitle(label = 'Distribution of NDDIE scores among patients with and without migraine') +
...
ggplot(migraine_data, aes(x = migraine, y = abnas_memory)) +
  geom_boxplot(aes(fill = migraine)) +
  ggtitle(label = 'Distribution of ABNAS Memory scores among patients with and without migraine') +
...
ggplot(migraine_data, aes(x = migraine, y = abnas_language)) +
  geom_boxplot(aes(fill = migraine)) +
  ggtitle(label = 'Distribution of ABNAS Language scores among patients with and without migraine') +
