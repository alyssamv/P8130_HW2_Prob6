...
There are data for 419 subjects in the data provided. Below are point and spread summaries for each of the variables given (CESD, NDDIE, and ABNAS scores for language and memory). First, for CESD scores, note that the range of possible values is (`r range(migraine_data$cesd, na.rm = T)`). 
